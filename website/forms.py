...
class IndexForm(FlaskForm):
    price = SelectField(
        ...
        choices=[(1, '0-1000'),(2, '1000-2000'), (3, '2000-3000'), (4, '3000-4000'), (5, '4000-5000'), (6, '5000-6000'),
                 (7, '6000-7000')],
        default = 2,
        coerce=int
    )
    ...
    phone_screen = SelectField(
        ...
        choices=[(1, '2.0~3.0 inches'), (2, '4.0~5.0 inches'), (3, '5.0~6.0 inches'), (4, '6.0~7.0 inches'),
                 (5, '7.0~8.0 inches')],
        default=4,
        coerce=int
    )
    phone_OS = SelectField(
        ...
        choices=[(1, '360'), (2, 'Android'), (3, 'ColorOS'), (4, 'COOL'),
    ...
    phone_resolution = SelectField(
        ...
        choices=[(1,'720P'),(2,'1080P'),(3,'2K'),(4,'4K')],
        default=1,
        coerce=int
    )
    phone_frequency = SelectField(
        label='Phone Frequency',
        choices=[(1,'1.0~1.5 GHz'),(2,'1.5~2.0 GHz'),(3,'2.0~2.2 GHz'),(4,'2.2~2.4 GHz'),(5,'2.4~2.6 GHz'),
    ...
    phone_kernel_num = SelectField(
        ...
        choices=[(1,'1 kernel'),(2,'2 kernel'),(3,'4 kernel'),(4,'6 kernel'),(5,'8 kernel')],
        default=5,
        coerce=int
    )
    phone_RAM_capacity = SelectField(
        label='Phone Random Access Memory',
        choices=[(1,'2GB'),(2,'3GB'),(3,'4GB'),(4,'6GB'),(5,'8GB'),(6,'12GB')],
        default=5,
        coerce=int
    )
    phone_ROM_capacity = SelectField(
        label='Phone Read Only Memory',
        choices=[(1,'32GB'),(2,'64GB'),(3,'128GB'),(4,'256GB'),(5,'512GB')],
        default=3,
        coerce=int
    )
    phone_battery_capacity = SelectField(
        label='Phone Battery Capacity',
        choices=[(1,'1000~2000mAh'),(2,'2000~3000mAh'),(3,'3000~4000mAh'),(4,'4000~5000mAh'),(5,'5000~6000mAh')],
        default=4,
        coerce=int
    )
    phone_rear_camera = SelectField(
        label='Phone Rear Camera',
        choices=[(1,'2 million pixels'),(2,'4 million pixels'),(3,'6 million pixels'),(4,'8 million pixels'),
    ...
    phone_front_camera = SelectField(
        ...
        choices=[(1,'5 million pixels'),(2,'7 million pixels'),(3,'8 million pixels'),(4,'10 million pixels'),
