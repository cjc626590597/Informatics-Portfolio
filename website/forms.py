...
class IndexForm(FlaskForm):
    price = SelectField(
        ...
        choices=[(1, '1000-2000'), (2, '2000-3000'), (3, '3000-4000'), (4, '4000-5000'), (5, '5000-6000'),
                 (6, '6000-7000')],
        default = 6,
        coerce=int
    )
    ...
    phone_screen = SelectField(
        ...
        choices=[(1, '2~2.8 inches'), (2, '4.2~4.7 inches'), (3, '5.05~5.99 inches'), (4, '6.0~6.9 inches'),
    ...
    phone_OS = SelectField(
        ...
        choices=[(1, 'Harmony'), (2, 'TiJOS'), (3, 'Android'), (4, 'Droi'),
    ...
    phone_kernel_num = SelectField(
        ...
        choices=[(1,'4 kernel'),(2,'6 kernel'),(3,'8 kernel')],
        default=3,
        coerce=int
    )
    ...
    phone_ROM_capacity = SelectField(
        ...
        choices=[(1,'32GB'),(2,'64GB'),(3,'128GB'),(4,'256GB'),(5,'512GB'),(6,'1TB')],
        default=6,
        coerce=int
    )
    ...
    phone_rear_camera = SelectField(
        ...
        choices=[(1,'8 million pixels'),(2,'12 million pixels'),(3,'13 million pixels'),(4,'16 million pixels'),
